                 ...
                 '<div class="modal-dialog">' +
                   '<div class="modal-content">' +
                     ...
                     '<div class="modal-footer">' +
                       '<button href="javascript:void(0)" class="btn btn-primary note-image-btn disabled" disabled="disabled">' + lang.image.insert + '</button>' +
                     '</div>' +
                   '</div>' +
                 '</div>' +
               '</div>';
        ...
        return '<div class="note-link-dialog modal" aria-hidden="false">' +
                 '<div class="modal-dialog">' +
                   '<div class="modal-content">' +
                     ...
                     '</div>' +
                     '<div class="modal-footer">' +
                       '<button href="javascript:void(0)" class="btn btn-primary note-link-btn disabled" disabled="disabled">' + lang.link.insert + '</button>' +
                     '</div>' +
                   '</div>' +
                 '</div>' +
               '</div>';
        ...
        return '<div class="note-video-dialog modal" aria-hidden="false">' +
                 '<div class="modal-dialog">' +
                   '<div class="modal-content">' +
                     ...
                     '</div>' +
                     '<div class="modal-footer">' +
                       '<button href="javascript:void(0)" class="btn btn-primary note-video-btn disabled" disabled="disabled">' + lang.video.insert + '</button>' +
                     '</div>' +
                   '</div>' +
                 '</div>' +
               '</div>';
