...
(function(a) {
	a.slidebars = function(b) {
		...
		if (v.MozTransition === "" || v.WebkitTransition === ""
				|| v.OTransition === "" || v.transition === "") {
			t = true
		}
		if (v.MozTransform === "" || v.WebkitTransform === ""
				|| v.OTransform === "" || v.transform === "") {
			k = true
		}
		...
		function o() {
			if (!x.disableOver
					|| (typeof x.disableOver === "number" && x.disableOver >= z)) {
				r = true;
		...
		function f() {
			...
			if (e
					&& (e.hasClass("sb-style-push") || e
							.hasClass("sb-style-overlay"))) {
				e.css("marginLeft", "-" + e.css("width"))
			}
			if (h
					&& (h.hasClass("sb-style-push") || h
							.hasClass("sb-style-overlay"))) {
		...
		function l(A) {
			if (g || j) {
				...
				setTimeout(function() {
					a("html").removeClass(
							"sb-active sb-active-left sb-active-right");
					if (e) {
