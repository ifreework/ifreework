...
import com.ifreework.service.system.AuthorityService;
...
public class AuthorityController extends BaseControllerSupport {
	...
	public ModelAndView gotoView() {
		...
		mv.setViewName("/system/authority/list");
		return mv;
	}
	...
	public PageData query(){
		...
		pd = authorityService.queryPageList(pd);
		return pd;
	}
}
